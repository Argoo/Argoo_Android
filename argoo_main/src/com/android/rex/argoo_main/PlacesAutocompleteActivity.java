...
public class PlacesAutocompleteActivity extends Activity implements
	...
	public void onItemClick(AdapterView<?> adapterView, View arg1, int arg2, long arg3) {
		...
		String str = (String) adapterView.getItemAtPosition(arg2);
 ...
 class PlacesAutoCompleteAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    private static final String API_KEY = "AIzaSyADMnhY6J28Sv_JJY0PkzAewqKh3YRwpis";
        ...
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    System.out.println("rex: resultList_size = "+resultList.size());
                }
